/**
*Tyler Valentine
*Recitation 13 Monika Tak (Best Teacher Ever!)
*Assignment 8
*Hey Monika! Due to the amount of code we're dealing with here, I'm going to omit comments for things
*that are obvious like "myfile.open(filename) // opens a file" etc... hope that's cool. Obviously
*if you have any questions feel free to email me or we can talk in the interview. _Tyler
*/
...
string OpeningSequence (string filenameM, string filenameF)
{
    ...
    cout << "                             GAME" << endl;
    cout << endl;
    cout << "              Copyright 2017 -- Loverboy Studios" << endl;
        for (int i = 0; i < 5; i++)
        {
            cout << endl;
        }
